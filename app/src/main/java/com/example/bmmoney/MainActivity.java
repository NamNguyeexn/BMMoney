...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        Double incomeValue = database.transactionDao().getTotalIncome();
        Double expenseValue = database.transactionDao().getTotalExpense();
        double income = incomeValue == null ? 0 : incomeValue;
        double expense = expenseValue == null ? 0 : expenseValue;
